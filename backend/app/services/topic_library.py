...
完成标准：页面能正常显示 3 张名片，点击关注按钮状态能正确切换。""",
                ...
                "resources": [
                    ...
                    {"type": "video", "title": "10分钟学会 React", "url": "", "embed_url": "", "platform": "B站", "level": "入门", "duration": "10分钟", "why": "短视频快速了解 React 全貌"},
                ],
            },
            2: {
                "name": "基础构建",
...
完成标准：刷新页面后数据不丢失，所有增删改功能正常。""",
                ...
                "resources": [
                    {"type": "video", "title": "React Hooks 完全指南", "url": "", "embed_url": "", "platform": "B站", "level": "入门", "duration": "45分钟", "why": "全面讲解 useState、useEffect 等核心 Hooks"},
                ],
            },
            3: {
                "name": "实践应用",
...
完成标准：能搜索电影、查看详情、添加收藏，刷新后收藏数据保留。""",
                ...
                "resources": [
                    {"type": "video", "title": "React Router v6 路由实战", "url": "", "embed_url": "", "platform": "B站", "level": "进阶", "duration": "40分钟", "why": "系统讲解路由配置与嵌套路由"},
...
完成标准：翻译质量优于机器直译，能保持上下文连贯性。""",
                ...
                "resources": [
                    {"type": "video", "title": "LLM 入门：从零理解大模型", "url": "", "embed_url": "", "platform": "B站", "level": "入门", "duration": "45分钟", "why": "通俗易懂的 LLM 原理讲解"},
                ],
            },
            2: {
                "name": "基础构建",
