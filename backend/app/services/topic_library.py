...
完成标准：页面能正常显示 3 张名片，点击关注按钮状态能正确切换。""",
                "resources": [
                    {"type": "video", "title": "React 官方教程 - 快速入门", "url": "https://react.dev/learn", "platform": "React 官网", "level": "入门", "duration": "30分钟", "why": "官方出品，最权威最简洁的入门指南"},
...
完成标准：刷新页面后数据不丢失，所有增删改功能正常。""",
                "resources": [
                    ...
                    {"type": "article", "title": "useEffect 完全指南", "url": "https://overreacted.io/zh-hans/a-complete-guide-to-useeffect/", "platform": "Dan Abramov 博客", "level": "进阶", "duration": "30分钟", "why": "React 核心开发者写的 useEffect 深度解析"},
...
完成标准：能搜索电影、查看详情、添加收藏，刷新后收藏数据保留。""",
                "resources": [
                    {"type": "video", "title": "React Router v6 教程", "url": "https://reactrouter.com/en/main/start/tutorial", "platform": "React Router 官网", "level": "进阶", "duration": "40分钟", "why": "官方教程，最全面的路由配置指南"},
                    {"type": "article", "title": "Zustand 状态管理入门", "url": "https://docs.pmnd.rs/zustand/getting-started/introduction", "platform": "Zustand 文档", "level": "进阶", "duration": "20分钟", "why": "比 Redux 简单 10 倍的现代状态管理"},
                    {"type": "video", "title": "React Query 实战", "url": "https://tanstack.com/query/latest/docs/react/overview", "platform": "TanStack 文档", "level": "进阶", "duration": "35分钟", "why": "服务端状态管理的最佳实践"},
...
完成标准：程序能正常运行，所有功能无 bug。""",
                "resources": [
                    {"type": "video", "title": "Python 官方教程", "url": "https://docs.python.org/zh-cn/3/tutorial/", "platform": "Python 官方文档", "level": "入门", "duration": "60分钟", "why": "最权威的 Python 入门教程，中文翻译"},
                    {"type": "article", "title": "廖雪峰 Python 教程", "url": "https://liaoxuefeng.com/books/python/intro/index.html", "platform": "廖雪峰博客", "level": "入门", "duration": "45分钟", "why": "国内最流行的 Python 入门教程"},
                    {"type": "video", "title": "Python 30分钟入门", "url": "https://www.bilibili.com/video/BV1wD4y1o7AS", "platform": "B站", "level": "入门", "duration": "30分钟", "why": "短视频快速了解 Python 基础"},
                ],
            },
            2: {
                "name": "基础构建",
...
完成标准：程序能持久化存储，重启后数据不丢失。""",
                "resources": [
                    {"type": "video", "title": "Python 面向对象编程", "url": "https://docs.python.org/zh-cn/3/tutorial/classes.html", "platform": "Python 官方文档", "level": "进阶", "duration": "40分钟", "why": "官方类教程，清晰易懂"},
...
完成标准：能基于上传的文档准确回答问题，不编造内容。""",
                "resources": [
                    {"type": "video", "title": "RAG 实战教程", "url": "https://python.langchain.com/docs/tutorials/rag/", "platform": "LangChain 文档", "level": "进阶", "duration": "60分钟", "why": "RAG 最完整的实战教程"},
                    {"type": "article", "title": "向量数据库入门", "url": "https://docs.trychroma.com/getting-started", "platform": "Chroma 文档", "level": "进阶", "duration": "25分钟", "why": "最易上手的向量数据库"},
